...
def main():
    parser = argparse.ArgumentParser(description="Sweep stale organizations to inactive state.")
    parser.add_argument("--older-than-days", type=int, default=30, help="Days threshold (default 30)")
